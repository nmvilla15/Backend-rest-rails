...
'The fact entry could not be created. #{@fact.errors.full_messages.to_sentence}' },
  ...
  def update
    ...
    if @fact.update(fact_params)
        ...
        render json: { error: 'This entry could not be udpated. #{@fact.errors.full_messages.to_sentence}' }, status: 400
    end
  end
  ...
  def destroy
    # your code goes here
    @fact.destroy
    render json: { message: 'Fact was sucessfully deleted.' }, status: 200
  end
